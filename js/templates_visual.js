...
(function() {
  ...
  function openColorPanel($block) {
    ...
    var computedBg = $block.length ? window.getComputedStyle($block[0]).backgroundColor : null;
    var computedText = $block.length ? window.getComputedStyle($block[0]).color : null;
