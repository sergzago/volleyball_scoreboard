...
async function migrateCollection(collectionName) {
  ...
  // Специальная логика для коллекций volleyball и matches
...
async function main() {
  ...
  try {
    ...
    // Очистка данных в PocketBase перед миграцией отключена
    // await cleanAllPocketBaseData();
    
    const results = {};
    
    // Миграция коллекций (volleyball, matches) - auth_log исключена
    const collections = ['volleyball', 'matches'];
